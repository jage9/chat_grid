...
* Current versions: client `R376`, server `S373`.
...
* Elevators expose the standard emitted-sound controls, including direction and facing. This remains a normal object emitter and is not cabin audio; riders inside the elevator do not hear it.
