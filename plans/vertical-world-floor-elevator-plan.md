...
* Current versions: client `R375`, server `S372`.
...
* Elevators expose the standard emitted-sound controls, including direction and facing; the spatial source follows the car and riders through those heights.
