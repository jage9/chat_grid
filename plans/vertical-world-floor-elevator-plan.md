...
* Current versions: client `R374`, server `S371`.
...
* Elevators expose the standard emitted-sound controls; the spatial source follows the car and riders through those heights.
