...
- Use, secondary use, edit, inspect, and management offer held items alongside items on the current square. Transfer still requires the item to be dropped first.
