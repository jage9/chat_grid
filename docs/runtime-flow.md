...
- The elevator object's own `z` remains its canonical item position while rider and car travel heights change separately. Its optional emitter uses normal item floor rules and is suppressed for riders inside that elevator.
