...
- Remote footsteps also multiply the source/listener acoustic-zone transmission, keeping floor sounds outside a closed or moving elevator cabin and fading them with the door transition.
