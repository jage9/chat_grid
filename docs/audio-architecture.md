...
- An elevator's optional `emitSound` remains a normal object emitter rather than following the car. The client suppresses that elevator's emitter while the listener is inside it.
