...
- A held-item transfer updates ownership, `carrierId`, and position together after checking the recipient is online and has capacity. Ground-item transfers update ownership only.
